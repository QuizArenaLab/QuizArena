...
import { WorkspacePlaceholderProps } from "./WorkspacePlaceholder.types";
...
export function WorkspacePlaceholder({
  ...
  return (
    <div
      className={`flex flex-col items-center justify-center w-full h-full text-center bg-gray-50 rounded-2xl border border-dashed border-gray-300 ${sizeStyles} ${className}`}
    >
      <div
