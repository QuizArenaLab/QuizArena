...
export function ReportInvestigationPanel({
  ...
  async function handleMarkUnderReview() {
    const { markReportUnderReview } = await import("@/actions/reports");
  ...
  async function handleResolve() {
    ...
    const { resolveReport } = await import("@/actions/reports");
    await performAction(() => resolveReport(report.id, resolutionNotes));
  }

  async function handleDismiss() {
    const { dismissReport } = await import("@/actions/reports");
    await performAction(() =>
  ...
  async function handlePriorityChange(newPriority: string) {
    ...
    const { updateReportPriority } = await import("@/actions/reports");
