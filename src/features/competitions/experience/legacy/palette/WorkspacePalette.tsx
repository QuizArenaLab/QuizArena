...
export function WorkspacePalette() {
  ...
  const jumpToQuestion = (index: number) => {
    ...
    setShowMobilePalette(false); // Auto close on mobile
  };

  return (
    <div className="bg-slate-900 border border-slate-800 rounded-2xl shadow-xl flex flex-col h-[calc(100vh-8rem)]">
      {/* Legend */}
      <div className="p-4 border-b border-slate-800 bg-slate-900/50 space-y-2 text-xs font-medium text-slate-300">
