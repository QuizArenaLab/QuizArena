...
/**
 * QuizArena — Register Page
 *
 * New user registration with credentials.
 * Redirects to auto-login on success.
 */
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (contentType && contentType.includes("application/json")) {
        ...
        throw new Error(text || "Server error occurred during registration");
      }
      ...
      if (result?.error) {
        ...
        router.push(`${ROUTES.AUTH.SIGN_IN}?registered=true&email=${encodeURIComponent(email)}`);
        return;
      }
      ...
      <div className="w-full max-w-md space-y-8 rounded-xl bg-white p-8 sm:p-10 shadow-lg border border-gray-100">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Join QuizArena and start your exam prep journey.
          </p>
        </div>
