        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-4 shrink-0 flex flex-col gap-4">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-0.5">Search by name, username, email, or user ID.</p>
            </div>
            ...
            <div className="relative w-full max-w-xl">
              ...
              <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-1">
                <span className="text-[10px] text-gray-400 border border-gray-200 rounded px-1.5 py-0.5 bg-gray-50 font-mono">/</span>
              </div>
            </div>
